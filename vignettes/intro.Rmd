...
A one sample t-test is used to determine whether a sample of data comes from a population with a specific mean. The observations must be continuous, independent of each other, approximately distributed and should not contain any outliers.
